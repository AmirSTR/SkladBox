  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-canvas px-4 py-10">
      <section className="w-full max-w-lg rounded-2xl border border-slate-200 bg-white p-8 shadow-soft">
        ...
        <h1 className="mt-8 text-3xl font-bold text-ink">Регистрация</h1>
        <p className="mt-3 text-base leading-7 text-muted">
          Создайте компанию и начните с пустого склада без демо-данных
        </p>

        <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
          <TextField label="Имя" onChange={setName} value={name} />
          <TextField
